...
bool is_vector2_in_rect(const Vector2& p, const Rect& r);
...
std::unordered_map<char, Texture_bundle> create_char_texture_cache(
    ...
    gsl::not_null<TTF_Font*> font,
    SDL_Color color = {0xFF, 0xFF, 0xFF, 0xFF});
void render_text(const char_texture_cache& cache, gsl::not_null<SDL_Renderer*> renderer, std::string_view text, SDL_Point origin);
}
